#!/usr/bin/env python3
"""
Play Snake with PyTorch-trained AI
"""
...
def play_pytorch_ai(model_path: str = "models/best_snake_pytorch_final.pth", 
                   games: int = 1, 
                   visual: bool = True):
    """Play Snake with PyTorch AI"""
    
    print(f"Loading PyTorch AI model from: {model_path}")
    try:
        ai = SnakeAI.load(model_path)
    ...
    for game_num in range(games):
        ...
        if visual:
            ...
            pytorch_text = font_small.render("🔥 Powered by PyTorch", True, (0, 255, 0))
    ...
    if games > 1:
        ...
        print(f"🔥 PyTorch AI Performance Summary")


def main():
    parser = argparse.ArgumentParser(description='Play Snake with PyTorch AI')
    parser.add_argument('model', nargs='?', default='models/best_snake_pytorch_final.pth',
    ...
    play_pytorch_ai(args.model, args.games, visual)
